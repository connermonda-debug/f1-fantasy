...
export const CALENDAR = [
  ...
  { round: 16,  name: 'Bahrain Grand Prix in Malaysia',location: 'Kuala Lumpur',circuit: 'Sepang International',    date: '2026-10-04', sprint: false },
  { round: 17,  name: 'Singapore Grand Prix',         location: 'Marina Bay', circuit: 'Marina Bay',              date: '2026-10-11', sprint: true },
  { round: 18,  name: 'United States Grand Prix',     location: 'Austin',     circuit: 'COTA',                    date: '2026-10-25', sprint: false },
  { round: 19,  name: 'Mexico City Grand Prix',       location: 'Mexico City',circuit: 'Autódromo Hermanos R.',   date: '2026-11-01', sprint: false },
  { round: 20,  name: 'Brazilian Grand Prix',         location: 'São Paulo',  circuit: 'Interlagos',              date: '2026-11-08', sprint: false },
  { round: 21,  name: 'Las Vegas Grand Prix',         location: 'Las Vegas',  circuit: 'Las Vegas Strip',         date: '2026-11-22', sprint: false },
  { round: 22,  name: 'Qatar Grand Prix',             location: 'Lusail',     circuit: 'Lusail International',    date: '2026-11-29', sprint: false },
  { round: 23,  name: 'Abu Dhabi Grand Prix',         location: 'Abu Dhabi',  circuit: 'Yas Marina',              date: '2026-12-06', sprint: false },
];
